...
**Vous pouvez choisir n'importe quel hébergeur même s'il n'est pas dans cette liste**, il suffit qu'il respecte les [prérequis](./requirements.md). Ces hébergeurs certifient qu'il est possible d'installer ClientXCMS sur leurs Hébergements Web.
...
Si votre société remplie ces conditions, vous pouvez nous demander de la rajouter.
